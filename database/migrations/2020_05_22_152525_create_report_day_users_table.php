...
/**
 * Class CreateReportDayUsersTable
 */
class CreateReportDayUsersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE `report_day_users` comment '用户个人日报表'");
    }
    ...
    {
        Schema::dropIfExists('report_day_users');
    }
}
