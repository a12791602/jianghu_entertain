    ...
    public function run(): void
    {
        SystemRoutesMerchant::insert(
            [
             ...
             [
              'route_name'    => 'merchant-api.frontend-user.store',
              'menu_group_id' => 4,
              'title'         => '会员管理-会员列表-添加',
              'is_open'       => 0,
              'is_ack'        => 0,
             ...
             [
              'route_name'    => 'merchant-api.frontend-user.detail',
              'menu_group_id' => 4,
              'title'         => '会员管理-会员列表-详情',
              'is_open'       => 0,
              'is_ack'        => 0,
             ...
             [
              'route_name'    => 'merchant-api.frontend-user.withdrawals-password.reset',
              'menu_group_id' => 4,
              'title'         => '会员管理-会员列表-重置取款密码',
              'is_open'       => 0,
              'is_ack'        => 0,
              'controller'    => 'App\Http\Controllers\BackendApi\Merchant\User\FrontendUserController',
              'method'        => 'withdrawalsPassword',
             ],
             [
              'route_name'    => 'merchant-api.frontend-user.alipay.destroy',
              'menu_group_id' => 4,
              'title'         => '会员管理-会员列表-清空支付宝',
              'is_open'       => 0,
              'is_ack'        => 0,
              'controller'    => 'App\Http\Controllers\BackendApi\Merchant\User\FrontendUserController',
              'method'        => 'alipayDestroy',
             ],
             [
              'route_name'    => 'merchant-api.frontend-user.unlock',
              'menu_group_id' => 4,
              'title'         => '会员管理-会员列表-解锁',
              'is_open'       => 0,
              'is_ack'        => 0,
             ...
             [
              'route_name'    => 'merchant-api.user-account.index',
              'menu_group_id' => 15,
              'title'         => '财务管理-资金帐变-列表',
              'is_open'       => 0,
              'is_ack'        => 0,
             ...
             [
              'route_name'    => 'merchant-api.report.user',
              'menu_group_id' => 30,
              'title'         => '报表管理-个人报表-列表',
              'is_open'       => 0,
              'is_ack'        => 0,
             ...
             [
              'route_name'    => 'merchant-api.report.commission',
              'menu_group_id' => 33,
              'title'         => '报表管理-会员洗码-列表',
              'is_open'       => 0,
              'is_ack'        => 0,
             ...
             [
              'route_name'    => 'merchant-api.report.commission-detail',
              'menu_group_id' => 33,
              'title'         => '报表管理-会员洗码-详情',
              'is_open'       => 0,
              'is_ack'        => 0,
              'controller'    => 'App\Http\Controllers\BackendApi\Merchant\Report\ReportController',
              'method'        => 'commissionDetail',
             ],
             [
             ...
             [
              'route_name'    => 'merchant-api.promotion-pic.index',
              'menu_group_id' => 52,
              'title'         => '设置管理-推广图片配置-列表',
              'is_open'       => 0,
              'is_ack'        => 0,
              'controller'    => 'App\Http\Controllers\BackendApi\Merchant\Setting\PromotionPicController',
              'method'        => 'index',
             ],
             [
              'route_name'    => 'merchant-api.promotion-pic.do-add',
              'menu_group_id' => 52,
              'title'         => '设置管理-推广图片配置-添加',
              'is_open'       => 0,
              'is_ack'        => 0,
              'controller'    => 'App\Http\Controllers\BackendApi\Merchant\Setting\PromotionPicController',
              'method'        => 'doAdd',
             ...
             [
              'route_name'    => 'merchant-api.promotion-pic.edit',
              'menu_group_id' => 52,
              'title'         => '设置管理-推广图片配置-编辑',
              'is_open'       => 0,
              'is_ack'        => 0,
              'controller'    => 'App\Http\Controllers\BackendApi\Merchant\Setting\PromotionPicController',
              'method'        => 'edit',
             ...
             [
              'route_name'    => 'merchant-api.promotion-pic.delete',
              'menu_group_id' => 52,
              'title'         => '设置管理-推广图片配置-删除',
              'is_open'       => 0,
              'is_ack'        => 0,
              'controller'    => 'App\Http\Controllers\BackendApi\Merchant\Setting\PromotionPicController',
              'method'        => 'delete',
